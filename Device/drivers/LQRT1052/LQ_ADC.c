...
void LQ_ADC_Init(ADC_Type *base, ADCn_Ch_e CH)
{
    ...
    */
    ...
    //ADC_EnableHardwareTrigger(base,1);
    /* 硬件平均 */
    ADC_SetHardwareAverageConfig(base, kADC_HardwareAverageCount4);
    ...
    if(base == ADC1)
    {
        switch(CH)
        {
          case 0:
            ...
            break;
          case 1:
            IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_12_GPIO1_IO12,0U);                                    /* Software Input On Field: Input Path is determined by functionality */
            IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_12_GPIO1_IO12,0x10F1U);
            break;
          case 2:
            IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_13_GPIO1_IO13,0U);                                    /* Software Input On Field: Input Path is determined by functionality */
            IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_13_GPIO1_IO13,0x10F1U);
            break;
          case 3:
