...
#define AT_DTCRAM_SECTION(func) SDK_PRAGMA(data_alignment = 64) func @"DTCRAMAccess" 
#define AT_OCRAM_SECTION(func)  SDK_PRAGMA(data_alignment = 64) func @"OCRAMAccess"
#define AT_SDRAM_SECTION(func)  SDK_PRAGMA(data_alignment = 64) func @"SDRAMAccess"
#elif(defined(__ARMCC_VERSION))
#define AT_ITCRAM_SECTION(func) __attribute__((section("ITCRAMAccess"))) func
#define AT_DTCRAM_SECTION(func) __attribute__((section("DTCRAMAccess"))) __attribute__((aligned(64))) func
#define AT_OCRAM_SECTION(func)  __attribute__((section("OCRAMAccess")))  __attribute__((aligned(64))) func
#define AT_SDRAM_SECTION(func)  __attribute__((section("SDRAMAccess")))  __attribute__((aligned(64))) func
#elif(defined(__GNUC__))
#define AT_ITCRAM_SECTION(func) __attribute__((section("ITCRAMAccess"))) func
...
#define AT_SDRAM_SECTION(func)  __attribute__((section("SDRAMAccess"))) func
#endif    
